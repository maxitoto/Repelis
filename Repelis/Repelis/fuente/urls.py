...
from fuente.views import ViewPeliculas, ViewPelicula, ViewArtistas, ViewArtista, ViewRegistro, InicioSesionView, CerrarSesionView, actualizar_estado_critica, ViewBusqueda
...
urlpatterns = [
    ...
    path('busqueda/',ViewBusqueda.as_view(), name='busqueda')
]